...
func dbAddTxIndexEntries(dbTx database.Tx, block *monautil.Block, blockID uint32) error {
...
func dbRemoveTxIndexEntries(dbTx database.Tx, block *monautil.Block) error {
