...
//
// This function is safe for concurrent access.
func (b *BlockChain) ProcessBlock(block *monautil.Block, flags BehaviorFlags) (bool, bool, error) {
	b.chainLock.Lock()
	...
	if b.chainParams.Lyra2re2DGWv3Height + 24 < tip.height {
		...
		err := checkBlockSanity(block, b.chainParams.PowLimit, b.timeSource, BFNoPoWCheck)
		if err != nil {
			return false, false, err
		}
	}
