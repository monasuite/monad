...
func GetBlockWeight(blk *monautil.Block) int64 {
...
func GetTransactionWeight(tx *monautil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *monautil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
