...
type config struct {
	...
	MinRelayTxFee        decimal.Decimal `long:"minrelaytxfee" description:"The minimum transaction fee in BTC/kB to be considered a non-zero fee."`
...
func loadConfig() (*config, []string, error) {
	tempMinRelayTxFee := mempool.DefaultMinRelayTxFee
	// Default config.
	cfg := config{
		...
		MinRelayTxFee:        tempMinRelayTxFee.ToDecimalBTC(),
