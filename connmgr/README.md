...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/monasuite/monad/connmgr)
...
```bash
$ go get -u github.com/monasuite/monad/connmgr
```
