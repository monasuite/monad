...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*monautil.Block, error) {
	...
	blocks := make([]*monautil.Block, 0, 256)
	genesis := monautil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
