...
reason, the monad suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire monad
...
One of the major design goals of all core monad packages is to aim for complete
...
commits](https://github.com/monasuite/monad/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into monad.
...
Rejoice as you will now be listed as a [contributor](https://github.com/monasuite/monad/graphs/contributors)!
...
[ISC license](https://github.com/monasuite/monad/blob/master/LICENSE).  This is
the same license as all of the code in the monad suite.
