...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr monautil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*monautil.Tx, error) {
...
func CreateBlock(prevBlock *monautil.Block, inclusionTxs []*monautil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr monautil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*monautil.Block, error) {
	...
	blockTxns := []*monautil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := monautil.NewBlock(&block)
