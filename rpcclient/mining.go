...
func (c *Client) GenerateToAddressAsync(numBlocks int64, address monautil.Address, maxTries *int64) FutureGenerateToAddressResult {
...
func (c *Client) GenerateToAddress(numBlocks int64, address monautil.Address, maxTries *int64) ([]*chainhash.Hash, error) {
...
func (c *Client) SubmitBlockAsync(block *monautil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *monautil.Block, options *btcjson.SubmitBlockOptions) error {
