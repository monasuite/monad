...
const (
	...
	defaultMaxFeeRate = monautil.SatoshiPerBitcoin / 10
)
...
func (r FutureGetRawTransactionResult) Receive() (*monautil.Tx, error) {
	...
	return monautil.NewTx(&msgTx), nil
}
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*monautil.Tx, error) {
...
func (c *Client) CreateRawTransaction(inputs []btcjson.TransactionInput,
	amounts map[monautil.Address]monautil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsAsync(address monautil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(address monautil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address monautil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address monautil.Address, skip,
