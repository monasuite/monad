...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []monautil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []monautil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee monautil.Amount) FutureSetTxFeeResult {
	cmd := btcjson.NewSetTxFeeCmd(fee.ToDecimalBTC())
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee monautil.Amount) error {
...
func (c *Client) SendToAddressAsync(address monautil.Address, amount monautil.Amount) FutureSendToAddressResult {
	...
	cmd := btcjson.NewSendToAddressCmd(addr, amount.ToDecimalBTC(), nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddress(address monautil.Address, amount monautil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address monautil.Address,
	amount monautil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := btcjson.NewSendToAddressCmd(addr, amount.ToDecimalBTC(), &comment,
		&commentTo)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address monautil.Address, amount monautil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress monautil.Address, amount monautil.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := btcjson.NewSendFromCmd(fromAccount, addr, amount.ToDecimalBTC(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress monautil.Address, amount monautil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress monautil.Address, amount monautil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := btcjson.NewSendFromCmd(fromAccount, addr, amount.ToDecimalBTC(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress monautil.Address, amount monautil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress monautil.Address, amount monautil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress monautil.Address,
	amount monautil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[monautil.Address]monautil.Amount) FutureSendManyResult {
	convertedAmounts := make(map[string]decimal.Decimal, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToDecimalBTC()
	}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[monautil.Address]monautil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[monautil.Address]monautil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[monautil.Address]monautil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (monautil.Address, error) {
	...
	return monautil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []monautil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []monautil.Address, account string) (monautil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []monautil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []monautil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (monautil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
// chain params.
func (c *Client) GetNewAddress(account string) (monautil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (monautil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (monautil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (monautil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (monautil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (monautil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (monautil.Address, error) {
...
func (c *Client) GetAccountAsync(address monautil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address monautil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address monautil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address monautil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]monautil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]monautil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = monautil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]monautil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount monautil.Amount) FutureMoveResult {
	cmd := btcjson.NewMoveCmd(fromAccount, toAccount, amount.ToDecimalBTC(), nil,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) Move(fromAccount, toAccount string, amount monautil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount monautil.Amount, minConfirms int) FutureMoveResult {

	cmd := btcjson.NewMoveCmd(fromAccount, toAccount, amount.ToDecimalBTC(),
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount monautil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount monautil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount monautil.Amount,
...
func (c *Client) ValidateAddressAsync(address monautil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address monautil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]monautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListAccounts() (map[string]monautil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]monautil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (monautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (monautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (monautil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (monautil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (monautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (monautil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (monautil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (monautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (monautil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (monautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address monautil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address monautil.Address) (monautil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address monautil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address monautil.Address, minConfirms int) (monautil.Amount, error) {
...
func (c *Client) SignMessageAsync(address monautil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address monautil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address monautil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address monautil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*monautil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return monautil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address monautil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address monautil.Address) (*monautil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *monautil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *monautil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *monautil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *monautil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *monautil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *monautil.WIF, label string, rescan bool) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a monad chain server
